                    ...
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 ">
                            ...
                            <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                                ...
                                <li>
                                    <a
                                        ...
                                        rel="noreferrer"
                                        target="_blank"
                                        className="text-teal-600 transition hover:text-teal-700/75"
                                    >
                        ...
                        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                            <div className="text-center sm:text-left">
                                <p className="text-lg font-medium text-teal-600">About Us</p>
                            ...
                            <div className="text-center sm:text-left">
                                <p className="text-lg font-medium text-teal-600">Our Services</p>
                                ...
                                <ul className="mt-8 space-y-4 text-sm">
                                    ...
                                    <li>
                                        <a className="text-gray-500 transition " href="#"> Web Design </a>
                                    </li>

                                    <li>
                                        <a className="text-gray-500 transition " href="#"> Marketing </a>
                                    </li>
                                </ul>
                            </div>

                            <div className="text-center sm:text-left">
                                <p className="text-lg font-medium text-teal-600">Helpful Links</p>

                                <ul className="mt-8 space-y-4 text-sm">
                                    <li>
                                        <a className="text-gray-500 transition " href="#"> FAQs </a>
                                    </li>

                                    <li>
                                        <a className="text-gray-500 transition " href="#"> Support </a>
                                    </li>
                                    <li>
                                        <a className="text-gray-500 transition " href="#"> Live Chat </a>
                                    </li>
                                </ul>
                            </div>

                            <div className="text-center sm:text-left">
                                <p className="text-lg font-medium text-teal-600">Contact Us</p>
