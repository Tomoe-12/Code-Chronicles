    ...
    return (
        <div>
            <section className="text-gray-400  relative  ">
                <div className="px-5 xl:px-0 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                    <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                       <iframe width="100%" height="100%" title="map" className="absolute inset-0" frameBorder={0} marginHeight={0} marginWidth={0} scrolling="no" style={{ filter: 'grayscale(1) contrast(1.2) opacity(0.16)' }}  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d581.5465646394997!2d97.0286611237092!3d20.804708894725408!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30ce865e86528551%3A0x18f0ca042de79963!2sNyang%20Phyang%20Sakhan%20Qtr%2C%20Taunggyi!5e1!3m2!1sen!2smm!4v1718033065487!5m2!1sen!2smm" allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />

                        <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
                            <div className="lg:w-1/2 px-6">
                                <h2 className="title-font font-semibold text-white tracking-widest text-xs">ADDRESS</h2>
                                <p className="mt-1">No-131,Shwe Gu St,Nyang Phyang Sakhan Qtr,Taunggyi, Myanmar(Burmese)</p>
                            </div>
                            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                                <h2 className="title-font font-semibold text-white tracking-widest text-xs">EMAIL</h2>
                                <a className="text-teal-500 leading-relaxed">li8993han@gmail.com</a>
                                <h2 className="title-font font-semibold text-white tracking-widest text-xs mt-4">PHONE</h2>
                                <p className="leading-relaxed">09-785-146-940</p>
                            </div>
                        </div>
                    </div>
                    <div className="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                        <h2 className="text-teal-600 text-lg mb-1 font-medium title-font">Feedback</h2>
